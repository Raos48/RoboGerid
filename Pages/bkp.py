...
class Toplevel1:
    def run_automation(self):
        if self.file_path:
            # Modificar para executar em um processo separado
            command = f'python gerid.py "{self.file_path}"'
    ...
    def update_terminal(self):
        ...
        self.top.after(100, self.update_terminal)  # Use self.top em vez de self.root

    def __init__(self, top=None):

        self.top = top  # Adicione esta linha no início do __init__
        _bgcolor = '#d9d9d9'  # X11 color: 'gray85'
        _fgcolor = '#000000'  # X11 color: 'black'
        _compcolor = '#d9d9d9' # X11 color: 'gray85'
        _ana1color = '#d9d9d9' # X11 color: 'gray85'
        _ana2color = '#ececec' # Closest X11 color: 'gray92'
        font10 = "-family {Verdana} -size 13 -weight bold"
        ...
        self.Importar_Arquivo_de_Configuração.place(relx=0.015, rely=0.303
                , relheight=0.313, relwidth=0.951)
        ...
        self.Label1.place(relx=0.163, rely=0.484, height=23, width=497
                , bordermode='ignore')
        ...
        self.TButton1.place(relx=0.017, rely=0.484, height=27, width=77, bordermode='ignore')
        self.TButton1.configure(takefocus="")
        self.TButton1.configure(text='''Importar''')
        self.TButton1.configure(command=self.import_file)

        self.Labelframe1 = tk.LabelFrame(top)
        self.Labelframe1.place(relx=0.263, rely=0.051, relheight=0.283
                , relwidth=0.561)
        ...
        self.TCombobox1.place(relx=0.028, rely=0.357, relheight=0.482
        ...
        self.Labelframe2.place(relx=0.014, rely=0.04, relheight=0.283
                , relwidth=0.232)
        ...
        self.Label2.place(relx=0.133, rely=0.357, height=31, width=20
                , bordermode='ignore')
        self.Label2.configure(activebackground="#f9f9f9")
        self.Label2.configure(activeforeground="black")
        self.Label2.configure(background="#d9d9d9")
        self.Label2.configure(disabledforeground="#a3a3a3")
        self.Label2.configure(font="-family {Verdana} -size 11 -weight bold")
        ...
        self.Frame1.place(relx=0.015, rely=0.657, relheight=0.227
                , relwidth=0.951)
        ...
        self.Button2.place(relx=0.876, rely=0.222, height=28, width=68)
        ...
        self.TProgressbar1.place(relx=0.031, rely=0.707, relwidth=0.794
                , relheight=0.0, height=22)
        self.TProgressbar1.configure(length="514")
        self.TProgressbar1.configure(takefocus="0")

        self.Labelframe3 = tk.LabelFrame(top)
        self.Labelframe3.place(relx=0.835, rely=0.051, relheight=0.278
                , relwidth=0.124)
        ...
        self.Spinbox1.place(relx=0.866, rely=0.152, relheight=0.106
                , relwidth=0.074)
        ...
        self.terminal_frame.place(relx=0.015, rely=0.9, relheight=0.3, relwidth=0.97)
        
        # Terminal
        self.terminal = tk.Text(self.terminal_frame, wrap=tk.WORD, bg='black', fg='white')
        self.terminal.pack(fill='both', expand=True)
        
        # Configuração da fila e thread para o terminal
